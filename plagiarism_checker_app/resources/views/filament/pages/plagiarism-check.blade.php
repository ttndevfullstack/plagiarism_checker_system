                    ...
                    <div class="space-y-2">
                        ...
                        <div class="rounded border p-4 bg-gray-50 dark:bg-gray-800">
                            ...
                            >
                                ...
                                >
                                    <div class="font-medium mb-1 text-gray-900 dark:text-white">{{ $paragraph['similarity_percentage'] }}% Similar</div>
                                    @if(count($paragraph['sources']) > 0)
                                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Found in:</div>
                                        <ul class="space-y-1">
                                            @foreach($paragraph['sources'] as $source)
                                            <li class="truncate">
                                                <a href="{{ $source['url'] }}" target="_blank" class="text-primary-600 dark:text-primary-400 hover:underline">
                                                    {{ $source['title'] }} ({{ $source['similarity_percentage'] }}%)
                                                </a>
                                            </li>
                                            @endforeach
                                        </ul>
        ...
        <x-filament::card>
            ...
            <div class="space-y-4">
                ...
                <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Supported formats: PDF, DOCX, TXT</p>
                </div>
            </div>
